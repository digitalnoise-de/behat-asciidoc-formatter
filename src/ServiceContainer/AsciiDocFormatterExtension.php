                    ...
                    ->children()
                        ->arrayNode('scenario')
                            ...
                            ->children()
                                ...
                                ->scalarNode('failed')->defaultValue('[scenario-failed]#icon:times-circle[] %s#')->end()
                        ...
                        ->arrayNode('example')
                            ->addDefaultsIfNotSet()
                            ->children()
                                ->scalarNode('passed')->defaultValue('icon:check-circle[]')->end()
                                ->scalarNode('failed')->defaultValue('icon:times-circle[]')->end()
                                ->scalarNode('undefined')->defaultValue('icon:question-circle[]')->end()
                            ->end()
                        ->end()
                        ->arrayNode('step')
                            ->addDefaultsIfNotSet()
